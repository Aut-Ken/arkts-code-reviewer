...
ReviewUnit                  RU-0～RU-3 已完成；v1 Golden 的 RU-2 target 仍为 14/16
...
和 GitCode 回写均是下游模块，不得为了完成 RU-4/RU-5 提前混入。下一项是 RU-4 的精确
ChangeSet/base/head 合同；RU-5 仍只负责有界关联上下文、分组和真实 code-context budget。
